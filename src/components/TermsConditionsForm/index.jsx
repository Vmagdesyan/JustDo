...
class _TermsConditionsForm extends React.Component {
  render() {
    const { history: { goBack } } = this.props;

    return (
      <div className="termsConditionsForm">
        <div className="termsConditionsForm__header">
          <BackButton onClick={goBack} />
          <Title value="Terms conditions"/>
        </div>
        <div className="termsConditionsForm__content">
          These terms and conditions («Terms», «Agreement») are an agreement between
          Mobile Application Developer («Mobile Application Developer», «us», «we» or «our»)
          ...
          are responsible for maintaining the security of your account and you are fully responsible
          ...
          You must immediately notify us of any unauthorized uses of your account or any other breaches of
          security. We will not be liable for any acts or omissions by you, including any damages of any
          kind incurred as a result of such acts or omissions. We may suspend, disable, or delete your
          ...
          property ownership or right to use of all submitted Content. We may, but have no obligation to,
          monitor Content in the Mobile Application submitted or created using our Services by you.
          Unless specifically permitted by you, your use of the Mobile Application does not grant us the
          license to use, reproduce, adapt, modify, publish or distribute the Content created by you or
          stored in your user account for commercial, marketing or any similar purpose. But you grant us
          permission to access, copy, distribute, store, transmit, reformat, display and perform the Content
          of your user account solely as required for the purpose of providing the Services to you.
        </div>
      </div>
    );
  }
...
export const TermsConditionsForm = withRouter(_TermsConditionsForm);